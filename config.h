...
#define STRING_CONFIG_H_AUTHOR "(sargantana Feb18)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "genericon"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.74, 78.74, 100, 95}
...
#define DEFAULT_ZJERK                 0.4    // (mm/sec) Must be same as XY for delta
